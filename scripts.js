...
let blobEnabled = false; // false => the blob is OFF by default
...
// navItems = Array.from(navItems).filter(item => item !== toggleBlobBtn);


navItems.forEach(item => {
    item.addEventListener("mouseenter", () => {
        // If blob is disabled, do nothing
